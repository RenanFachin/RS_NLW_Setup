...
export function Home() {
    ...
    // Chamando a função de fetchData com useEffect
                    ...
                    <View className="flex-row flex-wrap">
                        {
                            datesFromYearStart.map(date => {
                                // O summary inicialmente começa como NULL por isso é necessário adicionar {} por volta da view e por a condição de só renderizar caso exista um summary
                                // o método find do summary só "existe" para o typescript pela tipagem
